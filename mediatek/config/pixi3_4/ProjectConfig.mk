...
#modify by ersen.shang for pixi3-4
CUSTOM_HAL_IMGSENSOR = hi708_yuv sp0a19_yuv hi257_yuv sp2519_yuv hi351_yuv ov5645_mipi_yuv s5k5eayx_mipi_yuv
...
#modify by ersen.shang for pixi3-4
CUSTOM_HAL_MAIN_IMGSENSOR = hi257_yuv sp2519_yuv hi351_yuv ov5645_mipi_yuv s5k5eayx_mipi_yuv
...
#CUSTOM_HAL_SUB_BACKUP_IMGSENSOR= sp0718_yuv
...
#Modify by ersen.shang for pixi3-4
CUSTOM_KERNEL_IMGSENSOR = hi708_yuv sp0a19_yuv hi257_yuv sp2519_yuv hi351_yuv ov5645_mipi_yuv s5k5eayx_mipi_yuv
...
#Modify by linyaosen for soul4
#CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR= hi257_yuv
...
#Modify by ersen.shang for pixi3-4
CUSTOM_KERNEL_MAIN_IMGSENSOR = hi257_yuv sp2519_yuv hi351_yuv ov5645_mipi_yuv s5k5eayx_mipi_yuv
...
CUSTOM_KERNEL_TOUCHPANEL=ft6336_pixi4global msg2138a_pixi4global msg2238_pixi4global
...
CUSTOM_LK_LCM= hx8379c_wvga_dsi_vdo_TDT_6572 ili9806e_wvga_dsi_vdo_TXD_6572 hx8379c_wvga_dsi_vdo_dijing_6572 ili9806e_wvga_dsi_vdo_COE_6572  nt35512_wvga_dsi_vdo_TDT_6572
...
# 20150424 modify by zhangyong from "yes" to "no" for Bug983815
MTK_CTA_SET=no
...
#fangjie close for pixi3-4
#MTK_DUAL_MIC_SUPPORT=yes 
MTK_DUAL_MIC_SUPPORT=no
MTK_DUAL_MIC_USER_CONTROL_SUPPORT=yes
...
# closed by jinlong.sang 20141011 for pixi3-4
...
#fangjie close the DMNR feature, because pixi3-4 not has dual mic.
...
# PR621088, just keep JRD setupwizard,
MTK_OOBE_APP=no
...
#remove Mobile anti-theft for bug1131651 20160116 by heyan
...
#PR618582 For globel version, remove it
...
# Support the 3-in-1 speaker HW.  The speaker can be used as receiver, loud speaker, and vibrator.
 #fangjie enable MTK_VIBSPK_SUPPORT for pixi3-4
...
# Huang zeming change MTK_VOICE_UNLOCK_SUPPORT from yes to no for pixi34 bug852554 20141127
...
###Mark by Rock.Song for PR661877
...
CUSTOM_MODEM=jrdhz72_we_72_s1_kk_hspa
...
#4th:ili9806e_wvga_dsi_vdo_COE_6572 typeID:01bit
#2th for relook product nt35512_wvga_dsi_vdo_TDT_6572 01bit
CUSTOM_KERNEL_LCM=hx8379c_wvga_dsi_vdo_TDT_6572 ili9806e_wvga_dsi_vdo_TXD_6572 hx8379c_wvga_dsi_vdo_dijing_6572 ili9806e_wvga_dsi_vdo_COE_6572  nt35512_wvga_dsi_vdo_TDT_6572

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=hx8379c_wvga_dsi_vdo_TDT_6572 ili9806e_wvga_dsi_vdo_TXD_6572 hx8379c_wvga_dsi_vdo_dijing_6572 ili9806e_wvga_dsi_vdo_COE_6572  nt35512_wvga_dsi_vdo_TDT_6572
...
#Need customize audio parametes
...
#HAVE_MATV_FEATURE=yes #fangjie close for Pixi3-4
HAVE_MATV_FEATURE=no

# mATV chip select option: but MTK_MT5192 is only support on mt6516 platform
#MTK_ATV_CHIP=NMI5625 #fangjie close for Pixi3-4
MTK_ATV_CHIP=
...
#NXP NFC SUPPORT
#NXP_NFC_SUPPORT=yes #fangjie close for Pixi3-4
NXP_NFC_SUPPORT=no

#SOUL4 BACKLIGHT SUPPORT
SOUL4_BACKLIGHT_SUPPORT=yes
#SOUL4 CLK SUPPORT
JRD_HAL_ANT_CLK_SUPPORT=no
CUSTOM_MODEM = jrdhz72_we_72_s1_kk

CUSTOM_LK_LOGO = cu_wvga

MTK_VIDEO_FORCE_SEEK_WO_I = yes

# zhongyang.hu@tcl.com 2014-09-12 add for pixi3_4 build , begin
PIXI3_4_FEATURE_SUPPORT = yes
# zhongyang.hu@tcl.com 2014-09-12 add for pixi3_4 build , end

#BEGIN: add by fangjie for camera feature (US1-1S-5M(4013M):"Actual 5MP", other US1-1S(4013E):"SW 8MP (5MP)"), default "SW 8MP"
JRD_CAM_ACTUAL_5MP_SUPPORT=no
#END: add by fangjie for camera feature (US1-1S-5M(4013M):"Actual 5MP", other US1-1S(4013E):"SW 8MP (5MP)"), default "SW 8MP"
#add by fangjie for CTP simulate P-sensor
CTP_PSENSOR_SUPPORT=yes
#BEGIN: add 20150417 by xiaorong.ling for Relook
RELOOK_SUPPORT=FALSE
#END: add 20150417 by xiaorong.ling for Relook
