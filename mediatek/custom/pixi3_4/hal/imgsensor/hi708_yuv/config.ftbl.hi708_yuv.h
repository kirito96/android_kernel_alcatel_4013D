...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("640x480"), 
            ITEM_AS_VALUES_(
                "176x144","320x240","640x480","800x480",
            )
        ), 
    )	
#endif
    //==========================================================================
    /*Note: ersen.shang add "320x240" 20151123 follow requierment from app colleague*/
#if 1
    //  Video Size
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("640x480"), 
            ITEM_AS_VALUES_(
                "176x144", "320x240" ,"480x320",      "640x480"
            )
        ), 
    )
#endif
...
#if 1
    //  (Shot) Capture Mode
    /*Note: ersen.shang remove CAPTURE_MODE_FACE_BEAUTY for fix PR1115707*/
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
...
FTABLE_SCENE_DEP()
    //==========================================================================
/*begin ersen.shang modify Focus Mode for pr1014293 referenct sp0a19*/    
#if 1
    //  Focus Mode
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
...
#endif
/*end   ersen.shang modify Focus Mode for pr1014293 referenct sp0a19*/        
