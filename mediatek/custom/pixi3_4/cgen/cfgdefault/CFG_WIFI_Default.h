...
WIFI_CFG_PARAM_STRUCT stWifiCfgDefault_us =
{
	0x0104, /* Own Version For MT6628*/
	0x0000, /* Peer Version */
	{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, /* MAC ADDRESS */
	...
	/*BEGIN: modify by fangjie for PR884947,  US branch change the wifi  b/g mode tx power, EU branch keep default.*/
	 /*wifi 208.11b set to 14dBm (Cck&Dsss set to 0x1C * 0.5dBm)*/
	/*wifi 208.11g set to 13dBm (OFDM set to 0x1A * 05dBm)*/
	{ 0x1C, 0x1C, 0x00, 0x00, /*cTxPwr2G4Cck*/ /*cTxPwr2G4Dsss*/
	  0x1A, 0x1A, 0x1A, 0x1A, 0x1A, 0x1A, /*cTxPwr2G4OFDM*/
