...
#ifndef _CFG_AUDIO_PARAM_CUST_EU_HD_H
#define _CFG_AUDIO_PARAM_CUST_EU_HD_H
...
AUDIO_CUSTOM_PARAM_STRUCT speech_custom_default_cust_eu_hd =
{
...
AUDIO_VER1_CUSTOM_VOLUME_STRUCT audio_ver1_custom_default_cust_eu_hd = {
...
AUDIO_CUSTOM_WB_PARAM_STRUCT wb_speech_custom_default_cust_eu_hd =
{
...
AUDIO_ACF_CUSTOM_PARAM_STRUCT audio_custom_default_cust_eu_hd =
{
...
#if 0
AUDIO_ACF_CUSTOM_PARAM_STRUCT audiosub_custom_default_cust_eu_hd =
{
...
AUDIO_ACF_CUSTOM_PARAM_STRUCT audio_hcf_custom_default_cust_eu_hd =
{
...
AUDIO_ACF_CUSTOM_PARAM_STRUCT audio_vibspk_custom_default_cust_eu_hd =
{
    BES_LOUDNESS_HSF_COEFF_L,
	BES_LOUDNESS_BPF_COEFF_L,
	BES_LOUDNESS_LPF_COEFF_L,
...
AUDIO_ACF_CUSTOM_PARAM_STRUCT audio_musicdrc_custom_default_cust_eu_hd =
{
...
AUDIO_ACF_CUSTOM_PARAM_STRUCT audio_ringtonedrc_custom_default_cust_eu_hd =
{
...
AUDIO_EFFECT_CUSTOM_PARAM_STRUCT audio_effect_custom_default_cust_eu_hd =
{
    // DSRD parameters
    BSRD_LEVEL,
    BSRD_DISTANCE1,
...
AUDIO_PARAM_MED_STRUCT audio_param_med_default_cust_eu_hd =
{
...
AUDIO_VOLUME_CUSTOM_STRUCT audio_volume_custom_default_cust_eu_hd =
{
    AUD_VOLUME_RING,
    AUD_VOLUME_KEY,
    AUD_VOLUME_MIC,
...
AUDIO_CUSTOM_EXTRA_PARAM_STRUCT dual_mic_custom_default_cust_eu_hd =
{
...
AUDIO_GAIN_TABLE_STRUCT Gain_control_table_default_cust_eu_hd ={
...
AUDIO_HD_RECORD_PARAM_STRUCT Hd_Recrod_Par_default_cust_eu_hd = {
...
AUDIO_HD_RECORD_SCENE_TABLE_STRUCT Hd_Recrod_Scene_Table_default_cust_eu_hd = {
...
AUDIO_HD_RECORD_48K_PARAM_STRUCT Hd_Recrod_48k_Par_default_cust_eu_hd = {    
    //hd_rec_48k_fir
    DEFAULT_HD_RECORD_48K_COMPEN_FIR_Coeff
};

VOICE_RECOGNITION_PARAM_STRUCT Voice_Recognize_Par_default_cust_eu_hd = {
...
AUDIO_AUDENH_CONTROL_OPTION_STRUCT AUDENH_Control_Option_Par_default_cust_eu_hd = {    
    DEFAULT_AUDIO_AUDENH_CONTROL_OPTION_Coeff
};

AUDIO_BUFFER_DC_CALIBRATION_STRUCT Audio_Buffer_DC_Calibration_Par_default_cust_eu_hd = {
    0xFFFF,
    0,
    0,
    0
...
AUDIO_VOIP_PARAM_STRUCT Audio_VOIP_Par_default_cust_eu_hd = {    
...
AUDIO_ANC_CUSTOM_PARAM_STRUCT speech_ANC_custom_default_cust_eu_hd = {
