...
#ifndef _CFG_AUDIO_PARAM_CUST_US_RELOOK_H
#define _CFG_AUDIO_PARAM_CUST_US_RELOOK_H

/**** audio custom parameter ****/
#ifdef AUDIO_CUSTOM_H//audio_custom.h
#undef AUDIO_CUSTOM_H
#endif

#ifdef AUDIO_VER1_VOLUME_CUSTOM_DEFAULT_H//audio_ver1_volume_custom_default.h
#undef AUDIO_VER1_VOLUME_CUSTOM_DEFAULT_H
#endif

#ifdef AUDIO_VOLUME_CUSTOM_DEFAULT_H//audio_volume_custom_default.h
#undef AUDIO_VOLUME_CUSTOM_DEFAULT_H
#endif

#ifdef MED_AUDIO_CUSTOM_H//med_audio_default.h
#undef MED_AUDIO_CUSTOM_H
#endif

#ifdef SPEECH_COEFF_DEFAULT_H//sph_coeff_default.h
#undef SPEECH_COEFF_DEFAULT_H
#endif

//Add by ersen.shang for US_Relook has different hcf parameter. PR1005561
#ifdef AUDIO_HCF_DEFAULT_H
#undef AUDIO_HCF_DEFAULT_H
#endif

//Add by ersen.shang for US_Relook has different acf parameter. PR1005561
#ifdef AUDIO_ACF_DEFAULT_H
#undef AUDIO_ACF_DEFAULT_H
#endif

//delete by ersen.shang for US_Relook has different dmnr parameter than O2_UK
//#ifdef DMNR_PAR_SPEECH_COEFF_DEFAULT_H//sph_coeff_dmnr_default.h
//#undef DMNR_PAR_SPEECH_COEFF_DEFAULT_H
//#endif

//#include "sph_coeff_dmnr_default.h" //delete by ersen.shang for US_Relook has different dmnr parameter than O2_UK
...
#include "audio_acf_default.h" //Add by fangjie for O2_UK has different acf parameter. PR942640
#include "audio_hcf_default.h" //Add by ersen.shang for US_Relook has different acf parameter. PR1005561
/**** audio custom parameter end****/ 
...
//#include "../../../../inc/audio_acf_default.h" //delete by fangjie for O2_UK has different acf parameter than EU or US
...
AUDIO_CUSTOM_PARAM_STRUCT speech_custom_default_cust_US_Relook =
{
...
AUDIO_VER1_CUSTOM_VOLUME_STRUCT audio_ver1_custom_default_cust_US_Relook = {
...
AUDIO_CUSTOM_WB_PARAM_STRUCT wb_speech_custom_default_cust_US_Relook =
{
...
AUDIO_ACF_CUSTOM_PARAM_STRUCT audio_custom_default_cust_US_Relook =
{
...
#if 0
AUDIO_ACF_CUSTOM_PARAM_STRUCT audiosub_custom_default_cust_US_Relook =
{
...
AUDIO_ACF_CUSTOM_PARAM_STRUCT audio_hcf_custom_default_cust_US_Relook =
{
...
AUDIO_ACF_CUSTOM_PARAM_STRUCT audio_vibspk_custom_default_cust_US_Relook =
{
    BES_LOUDNESS_HSF_COEFF_L,
	BES_LOUDNESS_BPF_COEFF_L,
	BES_LOUDNESS_LPF_COEFF_L,
...
AUDIO_ACF_CUSTOM_PARAM_STRUCT audio_musicdrc_custom_default_cust_US_Relook =
{
...
AUDIO_ACF_CUSTOM_PARAM_STRUCT audio_ringtonedrc_custom_default_cust_US_Relook =
{
...
AUDIO_EFFECT_CUSTOM_PARAM_STRUCT audio_effect_custom_default_cust_US_Relook =
{
    // DSRD parameters
    BSRD_LEVEL,
    BSRD_DISTANCE1,
...
AUDIO_PARAM_MED_STRUCT audio_param_med_default_cust_US_Relook =
{
...
AUDIO_VOLUME_CUSTOM_STRUCT audio_volume_custom_default_cust_US_Relook =
{
    AUD_VOLUME_RING,
    AUD_VOLUME_KEY,
    AUD_VOLUME_MIC,
...
AUDIO_CUSTOM_EXTRA_PARAM_STRUCT dual_mic_custom_default_cust_US_Relook =
{
...
AUDIO_GAIN_TABLE_STRUCT Gain_control_table_default_cust_US_Relook ={
...
AUDIO_HD_RECORD_PARAM_STRUCT Hd_Recrod_Par_default_cust_US_Relook = {
...
AUDIO_HD_RECORD_SCENE_TABLE_STRUCT Hd_Recrod_Scene_Table_default_cust_US_Relook = {
...
AUDIO_HD_RECORD_48K_PARAM_STRUCT Hd_Recrod_48k_Par_default_cust_US_Relook = {    
    //hd_rec_48k_fir
    DEFAULT_HD_RECORD_48K_COMPEN_FIR_Coeff
};

VOICE_RECOGNITION_PARAM_STRUCT Voice_Recognize_Par_default_cust_US_Relook = {
...
AUDIO_AUDENH_CONTROL_OPTION_STRUCT AUDENH_Control_Option_Par_default_cust_US_Relook = {    
    DEFAULT_AUDIO_AUDENH_CONTROL_OPTION_Coeff
};

AUDIO_BUFFER_DC_CALIBRATION_STRUCT Audio_Buffer_DC_Calibration_Par_default_cust_US_Relook = {
    0xFFFF,
    0,
    0,
    0
...
AUDIO_VOIP_PARAM_STRUCT Audio_VOIP_Par_default_cust_US_Relook = {    
...
AUDIO_ANC_CUSTOM_PARAM_STRUCT speech_ANC_custom_default_cust_US_Relook = {
