...
#define NMI_POWER_VDDIO_PIN            GPIO23 //GPIO48//0xFF  //40        //gpio48  for VDDIO(2.8V)
#define NMI_POWER_VCORE_PIN            GPIO57//GPIO23 //GPIO70//0xFF //75  //   VCORE_1.2  
#define NMI_RESET_PIN               GPIO30 //GPIO78//0xFF //30  
#define NMI_ATV_ANT_PIN				GPIO56//GPIO135
#define NMI_FM_ANT_PIN				GPIO58//GPIO136
