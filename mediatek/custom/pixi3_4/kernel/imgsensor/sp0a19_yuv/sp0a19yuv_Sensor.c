...
//V1.0.1 Kavie 20141028 MTK6572 SP0A19 for TCL Pixi3-3.5
//V1.1.0 Kavie 20141030 MTK6572 SP0A19 for TCL Pixi3-3.5
//V1.1.0 Kavie 201411104 MTK6572 SP0A19 for TCL Pixi4
//V1.2.0 Kavie 201411130 MTK6572 SP0A19 for TCL Pixi3-4 sharpen,smooth
//V1.2.1 Kavie 20141225 MTK6572 SP0A19 for TCL Pixi3-4 肤色偏红问题
//V1.2.2 Kavie 20150305 MTKMTK6572 SP0A19 for TCL Pixi3-4 调整录像帧率
...
*
*************************************************************************/
static void SP0A19_awb_enable(kal_bool enable)
{	 
	...
	{
		SP0A19_write_cmos_sensor(0x32, (temp_AWB_reg & 0x05));
	}

}


static void SP0A19_ae_enable(kal_bool enable)
{	 
	...
	{
		SP0A19_write_cmos_sensor(0x32, (temp_AE_reg & 0x10));
	}
}
/*************************************************************************
* FUNCTION
...
void SP0A19NightMode(kal_bool bEnable)
{
	...
	{ 
		...
		if(SP0A19_MPEG4_encode_mode == KAL_TRUE)
		{
			...
			{
				//Video record night 24M 50hz 8-8FPS maxgain:0x8c
				SP0A19_write_cmos_sensor(0xfd,0x00);
	...
	else    // daylight mode
	{
		...
		if(SP0A19_MPEG4_encode_mode == KAL_TRUE)
		{
			...
			if(sp0a19_isBanding== 0)
			{
				...
				SP0A19_write_cmos_sensor(0xfd,0x00);        			
			#else//20150305 Kavie
			        //Video record daylight 24M 50Hz 10-10FPS maxgain:0x80
				SP0A19_write_cmos_sensor(0xfd,0x00);
				SP0A19_write_cmos_sensor(0x03,0x00);
			...
			else if(sp0a19_isBanding == 1)
			{
				...
				SP0A19_write_cmos_sensor(0xfd,0x00);			
			#else//20150305 Kavie
			    //Video record daylight 24M 60Hz 10-10FPS maxgain:0x80
				SP0A19_write_cmos_sensor(0xfd,0x00);
				SP0A19_write_cmos_sensor(0x03,0x00);
...
{  
	...
	//Kavie 20141030 Pixi3-3.5 sp0a19 xy-029Q
	SP0A19_write_cmos_sensor(0xfd,0x00);
	...
	SP0A19_write_cmos_sensor(0x31,0x60);//mirror[5] flip[6]
	...
	SP0A19_write_cmos_sensor(0x46,0xff);
	//ae setting
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0x03,0x01);
	SP0A19_write_cmos_sensor(0x04,0x32);
	...
	//SP0A19_write_cmos_sensor(0x58,0x07);//add test 20141126 Kavie from chenhui
	
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0xc4,0x56);
	SP0A19_write_cmos_sensor(0xc5,0x78);
	SP0A19_write_cmos_sensor(0xca,0x30);
	SP0A19_write_cmos_sensor(0xcb,0x45);
	SP0A19_write_cmos_sensor(0xcc,0x68);
	SP0A19_write_cmos_sensor(0xcd,0x48);
	SP0A19_write_cmos_sensor(0xfd,0x00);

	//lsc  for st
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x35,0x19);
	SP0A19_write_cmos_sensor(0x36,0x1c);
	SP0A19_write_cmos_sensor(0x37,0x1b);
	SP0A19_write_cmos_sensor(0x38,0x1c);
	SP0A19_write_cmos_sensor(0x39,0x1d);
	SP0A19_write_cmos_sensor(0x3a,0x1a);
	SP0A19_write_cmos_sensor(0x3b,0x1c);
	SP0A19_write_cmos_sensor(0x3c,0x1a);
	SP0A19_write_cmos_sensor(0x3d,0x18);
	SP0A19_write_cmos_sensor(0x3e,0x18);
	SP0A19_write_cmos_sensor(0x3f,0x19);
	SP0A19_write_cmos_sensor(0x40,0x1f);
	SP0A19_write_cmos_sensor(0x41,0x05);
	SP0A19_write_cmos_sensor(0x42,0x06);
	SP0A19_write_cmos_sensor(0x43,0x05);
	SP0A19_write_cmos_sensor(0x44,0x02);
	SP0A19_write_cmos_sensor(0x45,0x00);
	SP0A19_write_cmos_sensor(0x46,0xFE);
	SP0A19_write_cmos_sensor(0x47,0xFE);
	SP0A19_write_cmos_sensor(0x48,0x04);
	SP0A19_write_cmos_sensor(0x49,0xfA);
	SP0A19_write_cmos_sensor(0x4a,0x00);
	SP0A19_write_cmos_sensor(0x4b,0x02);
	SP0A19_write_cmos_sensor(0x4c,0x00);
	SP0A19_write_cmos_sensor(0xfd,0x00);
	//awb 1 
	SP0A19_write_cmos_sensor(0xfd,0x01);
	...
	//d65        
	SP0A19_write_cmos_sensor(0x65,0xc5);
	SP0A19_write_cmos_sensor(0x66,0xe5);
	SP0A19_write_cmos_sensor(0x67,0x72);
	SP0A19_write_cmos_sensor(0x68,0x90);
	//indoor     
	SP0A19_write_cmos_sensor(0x69,0xb8);
	SP0A19_write_cmos_sensor(0x6a,0xdc);
	SP0A19_write_cmos_sensor(0x6b,0x91);
	SP0A19_write_cmos_sensor(0x6c,0xb3);
	//f          
	SP0A19_write_cmos_sensor(0x61,0x6c);
	SP0A19_write_cmos_sensor(0x62,0x8c);
	SP0A19_write_cmos_sensor(0x63,0xc5);
	SP0A19_write_cmos_sensor(0x64,0xe6);
	//cwf        
	SP0A19_write_cmos_sensor(0x6d,0x94);
	SP0A19_write_cmos_sensor(0x6e,0xb8);
	SP0A19_write_cmos_sensor(0x6f,0xb4);
	SP0A19_write_cmos_sensor(0x70,0xd4);
	...
	SP0A19_write_cmos_sensor(0x58,0x0d);//0x0c  Kavie 20141225
	SP0A19_write_cmos_sensor(0x56,0x10);//0x0e  Kavie 20141225
	SP0A19_write_cmos_sensor(0x59,0x12);
	//GrGb?\BB\AC\E3\D0
	SP0A19_write_cmos_sensor(0x89,0x08);
	SP0A19_write_cmos_sensor(0x8a,0x0d);//0x0c  Kavie 20141225
	SP0A19_write_cmos_sensor(0x9c,0x10);//0x0e  Kavie 20141225
	SP0A19_write_cmos_sensor(0x9d,0x12);

	//Gr\Gb?\BC\E4 
	SP0A19_write_cmos_sensor(0x81,0xd0);//0xe0 Kavie 20141130
	SP0A19_write_cmos_sensor(0x82,0x90);//0xb0 Kavie 20141225
	SP0A19_write_cmos_sensor(0x83,0x60);
	SP0A19_write_cmos_sensor(0x84,0x20);
	//Gr\A1\A2Gb\B5\A5?
	SP0A19_write_cmos_sensor(0x85,0xd0);//0xe0 Kavie 20141130
	SP0A19_write_cmos_sensor(0x86,0x90);//0xb0 Kavie 20141225
	SP0A19_write_cmos_sensor(0x87,0x60);
	SP0A19_write_cmos_sensor(0x88,0x20);

	SP0A19_write_cmos_sensor(0x5a,0xe0);//0xff Kavie 20141130
	SP0A19_write_cmos_sensor(0x5b,0xa0);//0xb0 Kavie 20141225
	SP0A19_write_cmos_sensor(0x5c,0x60);//0x80 Kavie 20141225
	...
	SP0A19_write_cmos_sensor(0xe5,0x07);//0x05  Kavie 20141225
	SP0A19_write_cmos_sensor(0xd3,0x07);//0x05  Kavie 20141225
	SP0A19_write_cmos_sensor(0xd7,0x07);//0x05  Kavie 20141225

	SP0A19_write_cmos_sensor(0xe6,0x0b);//0x09 Kavie 20141225
	SP0A19_write_cmos_sensor(0xd4,0x0b);//0x09 Kavie 20141225
	SP0A19_write_cmos_sensor(0xd8,0x0b);//0x09 Kavie 20141225

	SP0A19_write_cmos_sensor(0xe7,0x10);
	SP0A19_write_cmos_sensor(0xd5,0x10);
	SP0A19_write_cmos_sensor(0xd9,0x10);
	...
	SP0A19_write_cmos_sensor(0xec,0x28);//0x2c Kavie 20141225
	SP0A19_write_cmos_sensor(0xe9,0x1c);//0x20 Kavie 20141130
	SP0A19_write_cmos_sensor(0xed,0x24);//0x2c Kavie 20141130
...
#if 0
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0xa0,0x81);
	SP0A19_write_cmos_sensor(0xa1,0xfe);
	SP0A19_write_cmos_sensor(0xa2,0x01);
	SP0A19_write_cmos_sensor(0xa3,0xfa);
	SP0A19_write_cmos_sensor(0xa4,0x8a);
	SP0A19_write_cmos_sensor(0xa5,0xfc);
	SP0A19_write_cmos_sensor(0xa6,0x03);
	SP0A19_write_cmos_sensor(0xa7,0xee);
	SP0A19_write_cmos_sensor(0xa8,0x8f);
	SP0A19_write_cmos_sensor(0xa9,0x0c);
	SP0A19_write_cmos_sensor(0xaa,0x33);
	SP0A19_write_cmos_sensor(0xab,0x0c);
	SP0A19_write_cmos_sensor(0xfd,0x00);
#else
	//CCM  Kavie 20141225     for pixi3-4 sanglaishi
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0xa0,0x79);
	SP0A19_write_cmos_sensor(0xa1,0x05);
	SP0A19_write_cmos_sensor(0xa2,0x01);
	SP0A19_write_cmos_sensor(0xa3,0xfd);
	SP0A19_write_cmos_sensor(0xa4,0x89);
	SP0A19_write_cmos_sensor(0xa5,0xfb);
	SP0A19_write_cmos_sensor(0xa6,0x06);
	SP0A19_write_cmos_sensor(0xa7,0xee);
	SP0A19_write_cmos_sensor(0xa8,0x8b);
	...
	SP0A19_write_cmos_sensor(0x8c,0x0f);
	SP0A19_write_cmos_sensor(0x8d,0x1c);
	SP0A19_write_cmos_sensor(0x8e,0x32);
	SP0A19_write_cmos_sensor(0x8f,0x55);
	SP0A19_write_cmos_sensor(0x90,0x6e);
	SP0A19_write_cmos_sensor(0x91,0x82);
	SP0A19_write_cmos_sensor(0x92,0x93);
	SP0A19_write_cmos_sensor(0x93,0xa2);
	SP0A19_write_cmos_sensor(0x94,0xae);
	SP0A19_write_cmos_sensor(0x95,0xba);
	SP0A19_write_cmos_sensor(0x96,0xc4);
	SP0A19_write_cmos_sensor(0x97,0xce);
	SP0A19_write_cmos_sensor(0x98,0xd7);
	SP0A19_write_cmos_sensor(0x99,0xe0);
	SP0A19_write_cmos_sensor(0x9a,0xe8);
	SP0A19_write_cmos_sensor(0x9b,0xef);
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x8d,0xf6);
	SP0A19_write_cmos_sensor(0x8e,0xfb);
	...
	SP0A19_write_cmos_sensor(0xd3,0x90);//0xa8 Kavie 20141225
	SP0A19_write_cmos_sensor(0xd4,0x90);//0xa8 Kavie 20141225
	SP0A19_write_cmos_sensor(0xd6,0x88);//0x9c Kavie 20141225
	SP0A19_write_cmos_sensor(0xd7,0x80);
	//HEQ        
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xdc,0x00);
	SP0A19_write_cmos_sensor(0xdd,0x7c);
	SP0A19_write_cmos_sensor(0xde,0xac);//0xB0 Kavie 20141225
	...
	SP0A19_write_cmos_sensor(0xf4,0x0a);//add Kavie 20141225
}
...
UINT32 SP0A19GetSensorID(UINT32 *sensorID)
{
	...
	//modified by zhangxinghong for pixi335
	printk("TCL:SP0A19 Read Sensor ID  = 0x%x\n", sensor_id); 
	if (sensor_id != SP0A19_SENSOR_ID) {
...
UINT32 SP0A19Open(void)
{
	...
	//\C5卸\CF\CA只\FA\B6\D4应目录\CF\C2\CA欠\F1\D3\D0\C3\FB为sp2528_sd \B5\C4\CE募\FE,没\D3\D0默\C8喜\CE\CA\FD

	//\BD\E9\D3诟\F7\D6\D6原\D2颍\BE\B0姹綷B3\F5始\BB\AF\B2\CE\CA\FD\D4\DA_s_fmt\D6小\A3
	struct file *fp; 
	mm_segment_t fs; 
	loff_t pos = 0; 
	...
	if(SP0A19_fromsd == 1)//\CA欠\F1\B4\D3SD\B6\C1取//gepeiwei   120903
	{
		printk("________________from t!\n");
		SP0A19_Initialize_from_T_Flash();//\B4\D3SD\BF\A8\B6\C1取\B5\C4\D6\F7要\BA\AF\CA\FD
	}
	else
	{
		SP0A19_Sensor_Init();
...
#define FLASH_BV_THRESHOLD 0x48    
static void SP0A19_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
	unsigned int NormBr=30;
	kal_uint16 SP0A19_sensor_ev = 0,SP0A19_sensor_bl= 0;
	printk("SP0A19_FlashTriggerCheck");

	SP0A19_write_cmos_sensor(0xfd, 0x00);
	NormBr = SP0A19_read_cmos_sensor(0xf2);
	printk("SP0A19_FlashTriggerCheck-0xf2= %x,\r\n",NormBr);
	SP0A19_sensor_ev = (SP0A19_read_cmos_sensor(0x03)<<8)|SP0A19_read_cmos_sensor(0x04);
	printk("SP0A19ev = %x,%x,%x\n",SP0A19_read_cmos_sensor(0x03),SP0A19_read_cmos_sensor(0x04),SP0A19_sensor_ev);
	if (1)//(SP0A19_sensor_ev >= 0x4c8)
	{	

		if (NormBr > FLASH_BV_THRESHOLD)
		{
			*pFeatureReturnPara32 = 0;
			printk("SP0A19_FlashTriggerCheck-FALSE");
			return;
		}
		else
		{
			*pFeatureReturnPara32 = 1;
			printk("SP0A19_FlashTriggerCheck-TRUE");
			return;
		}
							...
							UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	case SENSOR_FEATURE_SET_FLASHLIGHT:
		printk("[SP0A19] SENSOR_FEATURE_SET_FLASHLIGHT");
		break;
	case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO:
		SP0A19_FlashTriggerCheck(pFeatureData32);
		printk("[SP0A19] F_GET_TRIGGER_FLASHLIGHT_INFO: %d\n", pFeatureData32);
		break;
