...
#include <linux/hwmsen_dev.h>   //add by fangjie FR803765
...
static int CAMERA_HW_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    Create_Camera_node_ForMMI();   //add by fangjie for show camera info in MINISW screen, FR803765
