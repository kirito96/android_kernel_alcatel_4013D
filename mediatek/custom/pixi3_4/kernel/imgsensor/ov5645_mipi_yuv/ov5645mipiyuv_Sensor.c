...
void OV5645MIPIInitialSetting(void)
{
	...
	{		
		...
		OV5645MIPI_write_cmos_sensor(0x5187, 0x19);//17
		OV5645MIPI_write_cmos_sensor(0x5188, 0x10);//f 
		OV5645MIPI_write_cmos_sensor(0x5189, 0x78);//78
		OV5645MIPI_write_cmos_sensor(0x518a, 0x5d);//5c
		OV5645MIPI_write_cmos_sensor(0x518b, 0xf3);//f2
		OV5645MIPI_write_cmos_sensor(0x518c, 0x96);//95
		OV5645MIPI_write_cmos_sensor(0x518d, 0x34);//3a
		OV5645MIPI_write_cmos_sensor(0x518e, 0x2a);//2b
		OV5645MIPI_write_cmos_sensor(0x518f, 0x52);//5c
		OV5645MIPI_write_cmos_sensor(0x5190, 0x44);//45
		...
		OV5645MIPI_write_cmos_sensor(0x5198, 0x5 );//6 
		OV5645MIPI_write_cmos_sensor(0x5199, 0xd6);//2e
		OV5645MIPI_write_cmos_sensor(0x519a, 0x4 );//4 
		OV5645MIPI_write_cmos_sensor(0x519b, 0x0 );//0 
		OV5645MIPI_write_cmos_sensor(0x519c, 0x4 );//4 
		OV5645MIPI_write_cmos_sensor(0x519d, 0x75);//2e
		...
		OV5645MIPI_write_cmos_sensor(0x5301, 0x10);//	; sharpen MT th2
		OV5645MIPI_write_cmos_sensor(0x5302, 0x20);//	; sharpen MT off1  
		OV5645MIPI_write_cmos_sensor(0x5303, 0x04);//	; sharpen MT off2
		OV5645MIPI_write_cmos_sensor(0x5304, 0x08);//	; DNS th1
		OV5645MIPI_write_cmos_sensor(0x5305, 0x10);//	; DNS th2
		OV5645MIPI_write_cmos_sensor(0x5306, 0x08);//	; DNS off1
		OV5645MIPI_write_cmos_sensor(0x5307, 0x18);//	; DNS off2
		OV5645MIPI_write_cmos_sensor(0x5309, 0x08);//	; sharpen TH th1
		OV5645MIPI_write_cmos_sensor(0x530a, 0x10);//	; sharpen TH th2
		...
		OV5645MIPI_write_cmos_sensor(0x558b, 0x78);//
		OV5645MIPI_write_cmos_sensor(0x5800, 0x10);//lsc                                
		OV5645MIPI_write_cmos_sensor(0x5801, 0x14);//                                   
		OV5645MIPI_write_cmos_sensor(0x5802, 0x11);//                                   
		OV5645MIPI_write_cmos_sensor(0x5803, 0x11);//                                   
		OV5645MIPI_write_cmos_sensor(0x5804, 0x13);//                                   
		OV5645MIPI_write_cmos_sensor(0x5805, 0xf );//                                   
		...
		OV5645MIPI_write_cmos_sensor(0x581e, 0x13);//                                  
		OV5645MIPI_write_cmos_sensor(0x581f, 0x12);//
		OV5645MIPI_write_cmos_sensor(0x5820, 0xf );//
		OV5645MIPI_write_cmos_sensor(0x5821, 0xf );//
		OV5645MIPI_write_cmos_sensor(0x5822, 0x12);//
		...
		OV5645MIPI_write_cmos_sensor(0x5828, 0x48);//
		...
		OV5645MIPI_write_cmos_sensor(0x3a0f, 0x27);//	; AEC in H
		OV5645MIPI_write_cmos_sensor(0x3a10, 0x21);//	; AEC in L
		OV5645MIPI_write_cmos_sensor(0x3a1b, 0x27);//	; AEC out H
		OV5645MIPI_write_cmos_sensor(0x3a1e, 0x21);//	; AEC out L
		OV5645MIPI_write_cmos_sensor(0x3a11, 0x4f);//	; control zone H
		OV5645MIPI_write_cmos_sensor(0x3a1f, 0x11);//	; control zone L	
		OV5645MIPI_write_cmos_sensor(0x501d, 0x00);//	; control zone L	
		OV5645MIPI_write_cmos_sensor(0x3406, 0x00);//	; control zone L
	}
	else
	{
		OV5645MIPISENSORDB("[OV5645MIPI]enter OV5645MIPIInitialSetting function:\n ");
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	if(0 == sensor_module)
	{
		...
		OV5645MIPI_write_cmos_sensor(0x5303, 0x04);//	; sharpen MT 
		OV5645MIPI_write_cmos_sensor(0x5306, 0x08);//	; DNS off1  08+4
		OV5645MIPI_write_cmos_sensor(0x5307, 0x18);//	; DNS off2  10+4
	}
	else
	{
...
static void OV5645WBcalibattion(kal_uint32 color_r_gain,kal_uint32 color_g_gain,kal_uint32 color_b_gain)
{
	...
	if(0 ==sensor_module)
	{
		if(color_r_gain>0x5f0)//d65   66b 5a7 4a7 449   
		{
			if (temp>=0x70)
			{
...
UINT32 OV5645MIPIOpen(void)
{
	...
	//qiangbo.ni add for camera sensor 3rd module (litearray) 2014-02-22 start
#if 0
	mt_set_gpio_mode(GPIO21,GPIO_MODE_00);
	mt_set_gpio_pull_enable(GPIO21, GPIO_PULL_DISABLE);
	mt_set_gpio_dir(GPIO21,GPIO_DIR_IN);
	sensor_module = mt_get_gpio_in(GPIO21);
	if(1 == sensor_module)
	{
		printk("%s : 1st Module Q-Tech.\n", __func__);
	}
	else
	{
		printk("%s : 3rd Module LiteArray.\n", __func__);
	}
#endif 
	//qiangbo.ni add for camera sensor 3rd module (litearray) 2014-02-22 end
...
void OV5645MIPI_set_iso(UINT16 para)
{
	...
	case AE_ISO_200:
		...
		{
			OV5645MIPI_write_cmos_sensor(0x3a18, 0x00);
			OV5645MIPI_write_cmos_sensor(0x3a19, 0xa0);
		}
		else
		{
			OV5645MIPI_write_cmos_sensor(0x3a18, 0x00);
	...
	case AE_ISO_400:
		...
		break;
	//jiangjingjing-add-for-defect-124331-20140120-begin ersen.shang porting form pixi3.45 20150529
	case AE_ISO_800:  
		OV5645MIPI_write_cmos_sensor(0x3a18, 0x00);
	...
	case AE_ISO_1600:
		...
		break;
	//jiangjingjing-add-for-defect-124331-20140120-end ersen.shang porting form pixi3.45 20150529
	default:
		break;
	}
	return;
...
BOOL OV5645MIPI_set_param_exposure(UINT16 para)
{
	...
	case AE_EV_COMP_30: //jiangjingjing-add-for-defect-124333-20140120-begin  ersen.shang porting form pixi3.45 20150529
        ...
        break;         //jiangjingjing-add-for-defect-124333-20140120-end  ersen.shang porting form pixi3.45 20150529
	case AE_EV_COMP_20:	                   
	...
	case AE_EV_COMP_00:
		if(0 == sensor_module)
		{
			OV5645MIPI_write_cmos_sensor(0x3a0f, 0x27);//	; AEC in H
			OV5645MIPI_write_cmos_sensor(0x3a10, 0x21);//	; AEC in L
			OV5645MIPI_write_cmos_sensor(0x3a11, 0x4f);//	; AEC out H
			OV5645MIPI_write_cmos_sensor(0x3a1b, 0x27);//	; AEC out L
			OV5645MIPI_write_cmos_sensor(0x3a1e, 0x21);//	; control zone H
			OV5645MIPI_write_cmos_sensor(0x3a1f, 0x11);//	; control zone L  
		}
		else
		{
	...
	case AE_EV_COMP_n20:  // -2 EV
		...
		break;
	 case AE_EV_COMP_n30:	//jiangjingjing-add-for-defect-124333-20140120-begin  ersen.shang porting form pixi3.45 20150529                     				
