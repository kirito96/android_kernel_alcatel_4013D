...
else
{
	...
	GC0329_write_cmos_sensor(0xd2, 0x2a);	
       GC0329_write_cmos_sensor(0xd3, 0x40);//40
}
...
{																																																																										
	GC0329_write_cmos_sensor(0xd1,0x28);//zhao.li@tcl change from 0x34 to 0x2e																																																																									
	GC0329_write_cmos_sensor(0xd2,0x28);//zhao.li@tcl change from 0x34 to 0x2e	
}
///////////////////////////////////////////////
...

{
	...
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0x17, 0x14); //14
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0329_write_cmos_sensor(0x32, 0x84); 
			GC0329_SET_PAGE0;
			break;
