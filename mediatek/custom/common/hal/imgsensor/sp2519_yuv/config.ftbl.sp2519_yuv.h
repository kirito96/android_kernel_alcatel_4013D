...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                MtkCameraParameters::SCENE_MODE_HDR, //zhao.li@tcl add
            )
        ), 
    )
#endif
...
#if 1
    //  Preview Size
    //PR-638036-yibin.yang@tcl.com add "320x480" for video wallpaper
    #if 0
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "176x144","320x240","320x480","352x288","384x288", "432x240", "480x270", "480x320", "640x480",
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("320x240"), 
            ITEM_AS_VALUES_(
                "176x144","320x240","320x480","480x320","640x480","600x400","864x480"
            )
        ), 
    )
#endif
...
FTABLE_SCENE_DEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
//zhao.li@tcl del            ITEM_AS_DEFAULT_(MtkCameraParameters::FOCUS_MODE_AUTO), 
            ITEM_AS_DEFAULT_(MtkCameraParameters::FOCUS_MODE_INFINITY), //zhao.li@tcl add
            ITEM_AS_VALUES_(
//zhao.li@tcl del                MtkCameraParameters::FOCUS_MODE_AUTO,   
                MtkCameraParameters::FOCUS_MODE_INFINITY, 
//zhao.li@tcl del               MtkCameraParameters::FOCUS_MODE_CONTINUOUS_PICTURE, 
//zhao.li@tcl del                MtkCameraParameters::FOCUS_MODE_CONTINUOUS_VIDEO, 
            )
        ), 
        //......................................................................
    )
