...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                MtkCameraParameters::SCENE_MODE_HDR,//zhao.li@tcl add for Bug 497796
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "176x144",      "320x240",      "352x288",      "640x480",      "720x480", "768x432",   "800x480",	"1280x768",/*zhao.li@tcl 13.6.28 add 800x4801280x768 for Bug 480655*/
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("640x480"), 
            ITEM_AS_VALUES_(
                "176x144",      "320x240",      "352x288",      "640x480",      "720x480",		"800x480", /*zhao.li@tcl 13.6.28 add 800x480 for Bug 480655*/
            )
        ), 
    )
#endif
