...
static int BMA222E_ReadData(struct i2c_client *client, s16 data[BMA222E_AXES_NUM])
{
	...
	{
                /*Begin 20141211 ersen.shang change the sequence of X,Y and reverse Z*/
		data[BMA222E_AXIS_X] = (s16)buf[BMA222E_AXIS_Y*2] ;
		data[BMA222E_AXIS_Y] = (s16)buf[BMA222E_AXIS_X*2] ;
		data[BMA222E_AXIS_Z] = (s16)buf[BMA222E_AXIS_Z*2] ;
		/*End   20141211 ersen.shang change the sequence of X,Y and reverse Z*/
