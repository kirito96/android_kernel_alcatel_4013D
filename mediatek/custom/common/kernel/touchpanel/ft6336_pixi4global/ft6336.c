...
static unsigned char CTPM_FW_PIXI4_JUNDA[]=
{
	...
	//#include "Pixi3_4_6336_ID85_V17_20141205_app.i"  
	//#include "Pixi3_4_6336_ID85_V18_20141225_app.i"
	//#include "Pixi3_4_6336_ID85_V19_20150115_app.i"	
	#include "Pixi3_4_6336_ID85_V1a_20150228_app.i"
};
typedef enum
{
    ERR_OK,
...
static struct mutex i2c_transfer_mutex_ft6336 ;
...
{
	/*Begin ersen.shang 20150302 reference PR923657 for avoid p-sensor invalid*/
	mutex_lock(&i2c_transfer_mutex_ft6336);
	/*End ersen.shang 20150302 reference PR923657 for avoid p-sensor invalid*/	
	...
	/*Begin ersen.shang 20150302 reference PR923657 for avoid p-sensor invalid*/	
	mutex_unlock(&i2c_transfer_mutex_ft6336);
	/*End   ersen.shang 20150302 reference PR923657 for avoid p-sensor invalid*/
...
int ft6336_pls_disable(void)
{
	...
	fps_state = -1; //add by fangjie for PR872880 
	ft6336_pls_opened = 0;
	return 0;
}	
...
//	if(point_num == 0) return false;
 ...
 static int touch_event_handler(void *unused)
 {
	...
	{
		printk("TPD PS close mode________ continue \n");
		continue;
	}
#endif
 ...
 {	 
	...
	/*Begin ersen.shang 20150302 reference PR923657 for avoid p-sensor invalid*/
	mutex_init(&i2c_transfer_mutex_ft6336);
	/*End   ersen.shang 20150302 reference PR923657 for avoid p-sensor invalid*/
