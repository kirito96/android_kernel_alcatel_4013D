...
unsigned char MSG_FIRMWARE_EACH[94*1024] =
{
	...
	//#include "Pixi3_4_MSG2138A_EACH_V5.07_141231.h"
	//#include "Pixi3_4_MSG2138A_EACH_V5.08_150115.h"
#if defined(TARGET_RELOOK_SUPPORT)
	//#include "Pixi3_4_Relook_MSG2138A_EACH_V5.0A_150415.h"
/*Begin ersen.shang for update firmware to v5.101 of pixi3-4 relook*/	
	  #include "Pixi3_4_Relook_MSG2138A_EACH_V5.101_150514.h"
/*End   ersen.shang for update firmware to v5.101 of pixi3-4 relook*/		  
#else	
	/*Begin ersen.shang for update firmware to v5.10 of pixi3-4*/	
	//#include "Pixi3_4_MSG2138A_EACH_V5.09_150319.h"
	  #include "Pixi3_4_MSG2138A_EACH_V5.10_150619.h"
	/*Begin ersen.shang for update firmware to v5.10 of pixi3-4*/	
#endif	  
};
...
/*Begin ersen.shang 20150302 reference pr923657 for avoid p-sensor invalid*/
static struct mutex i2c_transfer_mutex_msg2138a ;
/*End ersen.shang 20150302 reference pr923657 for avoid p-sensor invalid*/

/*Begin ersen.shang 20150609 for fix pr1018382 p-sensor invalid after sleep reference pr973124*/
static int tp_in_suspend = 0;
/*End   ersen.shang 20150609 for fix pr1018382 p-sensor invalid after sleep reference pr973124*/
...
{
	/*Begin ersen.shang 20150302 reference pr923657 for avoid p-sensor invalid*/
	mutex_lock(&i2c_transfer_mutex_msg2138a);
	/*End ersen.shang 20150302 reference pr923657 for avoid p-sensor invalid*/	
	...
	/*Begin ersen.shang 20150302 reference pr923657 for avoid p-sensor invalid*/
	mutex_unlock(&i2c_transfer_mutex_msg2138a);
	/*End ersen.shang 20150302 reference pr923657 for avoid p-sensor invalid*/	
...
static void ito_test_reset(void)//modify for the actual Pixi3-4 project.
{
	...
	mdelay(5);
	mt_set_gpio_out(GPIO_CTP_EN_PIN, GPIO_OUT_ONE);
	mdelay(200); //Add by fangjie for Rawdata test. FR915452
}
...
ITO_TEST_END:
	...
	ito_test_reset();
	mdelay(100); //Add by fangjie for Rawdata test. FR915452
	ito_test_enable_irq();
...
static DEVICE_ATTR(memory, 0644, firmware_memory_show,firmware_memory_store);
...
#endif
		//printk ("HAL u32X = %x, u32Y = %x, val[5] =%x \n", u32X, u32Y, val[5]);
...
{	 
	...
	/*Begin ersen.shang 20150302 reference pr923657 for avoid p-sensor invalid*/
	mutex_init(&i2c_transfer_mutex_msg2138a);
	/*End   ersen.shang 20150302 reference pr923657 for avoid p-sensor invalid*/
