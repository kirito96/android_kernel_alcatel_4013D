...
static int simple_sd_ioctl_single_rw(struct msdc_ioctl* msdc_ctl)
{
	...
	//BEGIN: fangjie merge MTK patch ALPS01857674(For_JRDHZ72_WE_72_S1_KK_ALPS.KK1.MP6.V1_P24)
    if(!msdc_ctl)
        return -EINVAL; 
    if(msdc_ctl->total_size <= 0)
        return -EINVAL; 
	//END: fangjie merge MTK patch ALPS01857674(For_JRDHZ72_WE_72_S1_KK_ALPS.KK1.MP6.V1_P24)
